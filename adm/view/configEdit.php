        ...
        <form action="../controller/controller.php" method="post" name="admNew">
            ...
            <div class="divFlex">
                ...
                <div>
                    ...
                    <input class="inputFantasia" type="text" name="abre" value="<?= $config["Abre"]?>" required ><br><br>
                </div>
            ...
            <div class="divFlex">
                ...
                <div>
                    ...
                    <input class="inputProduto" type="text" name="fecha" id="fecha" value="<?= $config["Fecha"]?>"><br><br>
                </div>

                <div>
                    <label for="pedido">Nr.Pedido</label><br>
                    <input class="inputnome" id="pedido" type="number" name="pedido" value="<?= $config["NrPedido"] ?>" required maxlength="18"><br><br>
                </div>
