...
<body>
    ...
    <div id="admForm"><!-- esta no adm.css -->
        <form action="../controller/controller.php" method="post" name="admNew">
            <input type="hidden" name="cliente_new" value="value">
            ...
            <textarea class="descricao" name="referencia"  id="descricao" cols="30" rows="10" style="resize: none;" required></textarea><br>
            <br>
