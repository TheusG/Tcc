...
--
-- Host: 127.0.0.1
-- Tempo de geração: 30-Nov-2023 às 23:38
...
ALTER TABLE `venda`
  ...
  ADD CONSTRAINT `venda_ibfk_2` FOREIGN KEY (`Entregador`) REFERENCES `entregador` (`Id_Entregador`),
  ADD CONSTRAINT `venda_ibfk_3` FOREIGN KEY (`Pagamento`) REFERENCES `pagamento` (`Id_Pagamento`);
COMMIT;
